                    ...
                    <div className="flex justify-between items-end">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex items-center gap-3">
                                <span className="font-bold text-lg text-[#333]">27752675</span>
                            ...
                            <div className="flex items-center gap-3">
                                <span className="font-bold text-lg text-[#333]">44878069</span>
                                <div className="px-2 py-1 bg-white border border-gray-200 rounded shadow-sm flex items-center justify-center h-8 min-w-[60px]">
                        ...
                        <div className="flex flex-col gap-3 items-end">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="font-bold text-lg text-[#333]">df-hisso</span>
